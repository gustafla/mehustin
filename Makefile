...
PREFIX=release
PKGS=sdl2 gl
CFLAGS+=$(shell pkg-config --cflags $(PKGS)) -std=c99 -Ilib/stb -Ilib/rocket/lib -Ilib/gl-matrix.c -DGL_GLEXT_PROTOTYPES
...
release:CFLAGS+=-O2 -s -DSYNC_PLAYER
...
$(TARGET): $(OBJS)
	...
	cd lib/gl-matrix.c; make CFLAGS="-O2 -std=c99"
